...
@router.get('/get-product/{product_id}', status_code=200, response_model=ProductInDb)
...
@router.get('/get-user-products/{email}', status_code=200, response_model=ProductInDb)
