...
//   const fetchOffers = async (cat) => {
//     try {
//       const url =
//         cat === "all"
//           ? `/bingwa/get-all`
//           : `/bingwa/offers-by-category/${cat}`;
...
//   const saveOffer = async () => {
//     // decide method & path first (cleaner branching)
//     const isEditing = Boolean(editingId);
//     const method = isEditing ? "put" : "post";
//     const endpoint = isEditing
//       ? `/bingwa/update/${editingId}`
//       : "/bingwa/create";

//     try {
//       // Axios automatically:
//       //  • serialises JS objects to JSON for POST/PUT/PATCH
//       //  • parses JSON responses to JS objects
//       const { data } = await axiosClient.request({ method, url: endpoint, data: form });

//       // you can look at `data` for server feedback if needed
//       setForm(null);
//       setEditingId(null);
//       fetchOffers(category);
...
//     } catch (err) {
//       // Axios surfaces network + application errors the same way
...
//   const deleteOffer = async (id) => {
//     try {
//       const res = await fetch(`${baseUrl}/bingwa/delete/${id}`, { method: "DELETE" });
//       if (res.ok) fetchOffers(category);
//     } catch (err) {
...
//           <span className="text-indigo-700">{totalPages || 1}</span>
//         </span>
//         <button
...
// /*─────────────────────────────────────────────*
//  * Inline form row – used for both add & edit  *
//  *─────────────────────────────────────────────*/
// function OfferFormRow({ form, setForm, onSave, onCancel }) {
//   if (!form) return null;
...
//   return (
//     <tr className="bg-yellow-50 border-b border-slate-200 animate-fade-in">
//       {["price", "label", "validity"].map((field) => (
